                    ...
                    >
                        <div className={css.video_button}>
                            <div className={css.button_wrapper}>
                                <Image
                                    src={playicon}
                                    className={css.video_button_icon}
                                    layout="responsive"
                                    height={30}
                                    width={30}
                                    alt=""
...
export const VideoItemRegular = (props) => {
    ...
    const link =
        videoData.platform == 'local'
            ? '/Watch/' + videoData.videoId
            : 'https://www.youtube.com/watch?v=' + videoData.videoId
    const thumbnail = videoData.thumbnail.includes(
        'img/thumbnail_not_found.png'
    )
        ? thumbnails(videoData.videoId)
        : videoData.thumbnail
    return (
        <div className={css.video_item}>
            <div className={css.image_wrapper}>
