...
export function VideoPlayerMobile(props) {
    ...
    const onPressForwardOrBackward = (number) => {
        ...
        videoController.current.currentTime =
            videoController.current.currentTime + number
    }
    ...
    return (
        <div className={mobile_style.vertical_align}>
            <div
                className={mobile_style.video_wrapper}
                ref={videoPlayer}
                onClick={() => _handleClick()}
            >
                {playingAd && (
                    <div className={mobile_style.playing_ad_wrapper}>Ad</div>
                )}
                {muted && (
                    <div
                        className={mobile_style.unmute_button}
                ...
                <div
                    className={`${mobile_style.controls} ${
                        showControls && mobile_style.show_controls
                    }`}
                >
                    <div className={mobile_style.top_controls}>
                        <div
                            onClick={() => _handleClick('settings')}
                            className={`${mobile_style.settings} material-icons-round`}
                        >
                            settings
                        </div>
                    </div>
                    <div className={mobile_style.middle_controls}>
                        {loading ? (
                            ...
                            <>
                                <div
                                    className={`${mobile_style.skip_previous_btn} material-icons-round`}
                                    onClick={() => _handleClick('backward')}
                                >
                                    replay_10
                                </div>
                                <div
                                    className={`${mobile_style.play_pause_btn} material-icons-round`}
                                    onClick={() => _handleClick('PlayPause')}
                                >
                                    {isPlaying ? 'pause' : 'play_arrow'}
                                </div>
                                <div
                                    className={`${mobile_style.skip_next_btn} material-icons-round`}
                    ...
                    <div className={mobile_style.bottom_controls}>
                        <div className={mobile_style.duration_wrapper}>
                            <div className={mobile_style.duration}>
                                <div className={mobile_style.duration_current}>
                                    {duration.currentDuration}
                                </div>
                                <div
                                    className={mobile_style.duration_separator}
                                >
                                    /
                                </div>
                                <div className={mobile_style.duration_total}>
                                    {duration.totalDuration}
                                </div>
                            </div>
                            <div
                                className={`${mobile_style.fullscreen_btn} material-icons-round`}
                        ...
                        <div
                            ...
                            className={`${mobile_style.timeline_wrap}`}
                        >
                            <div className={mobile_style.timeline_panel}>
                                <div className={mobile_style.timeline_slider}>
                                    <div
                                        className={
                                            mobile_style.timeline_slider_track
                                        }
                                    >
                                        <div
                                            className={
                                                mobile_style.timeline_slider_progress
                                            }
                                            style={{
                                                width:
                                                    duration.percentage + '%',
                                        ...
                                        >
                                            <div
                                                className={
                                                    mobile_style.timeline_slider_handle
                                                }
                                            ></div>
                                        </div>
                                    </div>
                ...
                {showSettings && (
                    <div
                        className={`${mobile_style.bottom_settings_popup_wrapper}`}
                        onClick={() => _closeSettings()}
                    ></div>
                )}
                <div
                    className={`${mobile_style.bottom_settings_popup} ${
                        showSettings && mobile_style.show_setting
                    }`}
                >
                    <div className={mobile_style.settings_popup_header}>
                        <a className={mobile_style.settings_popup_title}>
                            Settings
                        </a>
                    </div>
                    <div className={mobile_style.settings_popup_body}>
                        {!settingsShowQuality && !settingsShowSpeed && (
                            <div
                                className={
                                    mobile_style.settings_popup_body_item
                                }
                                onClick={() => setSettingsShowQuality(true)}
                            >
                                <div
                                    className={`${mobile_style.settings_popup_body_item_icon} material-icons-round`}
                                ...
                                <div
                                    className={
                                        mobile_style.settings_popup_body_item_text
                                    }
                                >
                                    Quality
                                    <div
                                        className={mobile_style.current_quality}
                                    >
                                        {' '}
                                        {quality === 'auto'
                                            ? 'Auto'
                ...
                <div className={mobile_style.ad_wrapper}>
                    <div className={mobile_style.image_and_text_wrapper}>
                        ...
                        <div className={mobile_style.ad_text}>
                            boAt Immortal IM-1300 Over-Ear Wireless Gaming
                            Headphone with Mic (Bluetooth 5.1, Driverless 3D
                            Spatial Sound, Black Sabre)
                        </div>
                    </div>
                    <div className={mobile_style.ad_btn_wrapper}>
                        <div
                            className={mobile_style.ad_button}
