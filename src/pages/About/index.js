...
import {
    default as Insta15,
    default as insta3,
} from '../../assets/img/png/insta15.png'
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="keywords"
                    content="rakazone about, About, raka, rakazone, rakazonegaming, cool, rakazone cool"
                />
                ...
                <div className={css.about}>
                    <div className={css.about_main}>
                        ...
                        <h1 className={css.about_title}>
                            I&#8216;m{' '}
                            <span className="bold">Rishab Karanwal </span> AKA{' '}
                            <span className="bold">RakaZone.</span>
                            <br /> Gamer and Content Creator for{' '}
                            <span className="bold">VLT</span>
                        </h1>
                        <p className={css.about_description}>
                            Hi, My Name is Rishab Karanwal. I&#8216;m 29 & I
                            live in India.
                            <br /> I&#8216;m a Influencer, YouTuber, Vlogger*
                            and a Video Creator.
                        </p>
                        ...
                        <div
                            className={`${css.about_streamer_achievement} iso-layout-grid `}
                        >
                            <div className={css.card}>
                                ...
                                <div className={css.card_content}>
                                    <div
                                        className={
                                            css.about_streamer_achievement_count
                                        }
                                    >
                                        {streamerData.yt_subscribers_count}
                                    </div>
                                    <div
                                        className={
                                            css.about_streamer_achievement_text
                                        }
                                    >
                                        YouTube subscribers
                                    </div>
                            ...
                            <div className={css.card}>
                                ...
                                <div className={css.card_content}>
                                    ...
                                    >
                                        {streamerData.fb_followers_count}
                                    </div>
                                    <div
                                        className={
                                            css.about_streamer_achievement_text
                            ...
                            <div className={css.card}>
                                ...
                                <div className={css.card_content}>
                                    ...
                                    >
                                        {streamerData.twitter_followers_count}
                                    </div>
                                    <div
                                        className={
                                            css.about_streamer_achievement_text
                            ...
                            <div className={css.card}>
                                ...
                                <div className={css.card_content}>
                                    ...
                                    >
                                        {streamerData.insta_followers_count}
                                    </div>
                                    <div
                                        className={
                                            css.about_streamer_achievement_text
                    ...
                    <div className={css.story_about_me_left}>
                        <div className={css.story_about_me_content}>
                            <p>
                                <span className={css.story_about_titles}>
                                    One of the life lessons I can give you is
                                    that you can never predict the future by
                                    just thinking about it.{' '}
                                </span>{' '}
                                <br />I would have never predicted that I could
                                ever reach the place I am now. It would have
                                been impossible for me to meet such amazing
                                people if I had kept doing a 9-to-5 job. Going
                                on paths not taken will be challenging, but one
                                should never lose hope. Your passion might start
                                getting boring, and it may not excite you as it
                                used to. But it requires dedication to achieve
                                your goals.
                            </p>
                        </div>
                        <div className={css.story_about_me_image_left}>
                            <Image
                                ...
                                height={600}
                                alt="sdas"
                                className={css.story_about_img_left}
                            />
                        </div>
                    </div>
                    <div className={css.story_about_me_right}>
                        <div className={css.story_about_me_image_right}>
                            <Image
                                ...
                                height={600}
                                alt="sdas"
                                className={css.story_about_img_right}
                            />
                        </div>
                        <div className={css.story_about_me_content}>
                            <p>
                                ...
                                <br />
                                There's no such thing as overnight success. It
                                took me 6yrs to get where I'm right now, with a
                                lot of patience, hard work, and passion. In
                                life, it's crucial to keep moving, doing, and
                                brewing what you love. These are not RakaZone's
                                words, and I have tried my best to portray
                                RakaZone.
                            </p>
                        </div>
                    </div>
