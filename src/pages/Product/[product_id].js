        ...
        <>
            ...
            <div className="container-default">
                <div className={css.product_wrapper}>
                    ...
                    <div className={css.product_details}>
                        ...
                        <div className={css.product_price}>
                            <div className={css.actual_price}>
                        ...
                        <div className={css.product_quantity}>
                            ...
                            <div className={css.size_selector}>
                                <div className={css.size_selector_item}>
                                    {product.size.map((_size, index) => {
                                        if (
                                            product.size_not_in_stock.includes(
                                                _size
                                            )
                                        ) {
                                            return (
                                                <div
                                                    className={`${
                                                        _size == size
                                                            ? css.size_selector_item_text_selected
                            ...
                            <div className={css.quantity_input_wrapper}>
                                <div
                                    className={css.quantity_input_button}
                                    onClick={() => setQuantity(quantity - 1)}
                                >
                                    <Minus />
                                </div>
                                <div className={css.quantity_input}>
                                    {quantity}
                                </div>
                                <div
                                    className={css.quantity_input_button}
                        ...
                        <div className={css.delivery_to_pincode}>
                            ...
                            <div className={css.delivery_to_pincode_input}>
                                ...
                                />
                                <a
                                    className={css.delivery_to_pincode_btn}
                                    onClick={() =>
                                        toastService.success(
                                            constants.checking_pincode
                                        )
                                    }
                                >
                                    Check
                        ...
                        <div
                            className={css.product_add_to_cart}
                            onClick={() =>
                                toastService.success(
                                    constants.currently_disabled
                                )
                            }
                        >
                ...
                <div className={css.about_product_tabs}>
                    <div
                        className={`${css.product_tab} ${
                            activeTab == 'PRODUCT' ? css.active_tab : []
                        }`}
                    ...
                    <div
                        className={`${css.product_tab} ${
                            activeTab == 'SHIPPING' ? css.active_tab : []
                        }`}
                ...
                {/* TO BE DONE */}
                <div
                    className={`${css.about_product_tab_content} container-medium`}
                >
                    {activeTab == 'PRODUCT' && (
                        <>
                            <div className={css.product_tab_content}>
                                <div className={css.product_tab_content_title}>
                                    Product Details
                                </div>
                                <div
                                    className={
                                        css.product_tab_content_description
                                    }
                ...
                <div className={css.service_wrapper}>
                    <div className={css.service_title}>
                        <h1 className={css.service_title_text}>
                            All the orders include:
                        </h1>
                        <div className={css.service_sub_title}>
                            Our all orders include the best service,from
                            ordering your favorite product <br /> to getting it
                        ...
                        <div className={css.service_list_item}>
                            <div className={css.service_list_item_icon_wrapper}>
                                <div className={css.service_list_item_icon}>
                                    <Image
                                        src={fastshipping_img}
                                        alt="Fast Shipping"
                                    />
                                </div>
                            </div>
                            <div className={css.service_list_item_content}>
                                <div className={css.service_list_item_title}>
                                    Delivery to Pincode
                                </div>
                                <div
                                    className={
                                        css.service_list_item_description
                                    }
                                >
                                    We deliver to your Pincode.
                                </div>
                            </div>
                        </div>
                        <div className={css.service_list_item}>
                ...
                <div className={css.similar_products_wrapper}>
                    <div className={css.similar_products_title}>
                        <h1 className={css.similar_products_title_text}>
                            Similar Products
                        </h1>
                    </div>
                    <div className={css.similar_products_list}>
                        {similar_products.map((product, index) => {
                            return (
                                <div
                                    className={css.similar_products_item}
                                    key={index}
                                >
                                    <div
                                        className={
                                            css.similar_products_item_image
                                        }
                                    >
                                        <Image
...
export function getServerSideProps(context) {
    const productData = productsList.filter(
        (product) => product.seo_title == context.query.product_id
    )
    return {
