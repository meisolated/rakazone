...
function Home(props) {
    ...
    featuredPrimary.title =
        featuredPrimary.title.length > 60
            ? featuredPrimary.title.substring(0, 60) + '...'
            : featuredPrimary.title
    featuredSecondary.title =
        featuredSecondary.title.length > 60
            ? featuredSecondary.title.substring(0, 60) + '...'
            : featuredSecondary.title
    featuredTertiary.title =
        featuredTertiary.title.length > 60
            ? featuredTertiary.title.substring(0, 60) + '...'
            : featuredTertiary.title
    ...
    whatToShow.viewCount = whatToShow.viewCount
        ? whatToShow.viewCount
        : whatToShow.viewers_count
    const views = whatToShow.status == 'live' ? 'watching now' : 'views'
    const viewCont =
        whatToShow.platform === 'loco'
            ? whatToShow.viewCount
            : convertToInternationalCurrencySystem(
                parseInt(whatToShow.viewCount)
            )
            ...
            <div className="container-default">
                    ...
                    <div className={css.home_hero_left}>
                        ...
                        <div className={css.home_hero_channel_about}>
                            <div className={css.channel_about_content_top}>
                                ...
                                >{`${streamerData.yt_subscribers_count} SUBSCRIBERS`}</div>
                            </div>
                            <p className={css.about}>
                                <span className={css.bold}>
                                    Rishab Karanwal
                                </span>{' '}
                                most of you know me as Raka, I am a variety
                                streamer. If you say so.
                            </p>
                        </div>
                    </div>
                    <p className={css.mobile_about}>
                        <span className={css.bold}>Rishab Karanwal</span> most
                        of you know me as Raka, I am a variety streamer. If you
                        say so.
                    </p>
                ...
                <div className={css.video_featured_grid}>
                    <div className={css.video_featured_wrapper}>
                        <div className={css.image_wrapper}>
                            <Image
                                className={`${css.video_item_image} ${active
                                    ? css.image_active
                                    : css.image_inactive
                                    }`}
                            ...
                            <Link href={link} passHref prefetch={false}>
                                ...
                                >
                                    <div className={css.video_featured_button}>
                                        <div
                                            className={
                                                css.video_featured_button_icon_wrapper
                                            }
                                        >
                                            <Image
                                                src={playicon}
                                                className={
                                                    css.video_featured_button_icon_big
                                                }
                                                layout="responsive"
                                                height={30}
                                                width={30}
                            ...
                            <div
                                className={`${isLive
                                    ? css.video_featured_live_text
                                    : css.video_featured_text
                                    }`}
                            >
                                {isLive && (
                        ...
                        <div className={css.video_featured_content}>
                            <div
                                className={`pd-right ${css.video_featured_channel_image}`}
                            >
                                <Image
                            ...
                            <div>
                                <h2 className={css.video_featured_title}>
                                    {whatToShow.title}
                                </h2>
                                <div className={css.video_featured_about}>
                                    <div
                                        className={css.video_featured_duration}
                                    >
                                        <div>{viewCont}</div>
                                        <div>&nbsp;{views}</div>
                                    </div>
                                    <div
                                        className={css.video_about_divider}
                                    ></div>
                                    <div
                                        className={css.video_featured_duration}
                                    >
                    ...
                    <div
                        className={`${css.video_featured_secondary_grid} pd-bottom`}
                    >
                ...
                <div className={css.home_latest_videos}>
                    <div className={css.latest_videos_left}>
                        <h2 className={css.latest_videos_title}>
                            Recommended videos
                        </h2>
                    </div>
                    <div className={css.latest_videos_right}>
                        ...
                        >
                            <div className={css.latest_videos_arrow_link_text}>
                                Browse more videos
                            </div>
                        </Link>
                    </div>
                ...
                <div className={css.about_channel_grid}>
                    <div className={css.about_channel_left}>
                        <h1>Hey there!</h1>
                        <p>
                            I'm <span className="bold">Rishab Karanwal</span>.
                            Most of you know me as RakaZone, and I am a variety
                            streamer. You will see me playing multiple games on
                            my channel, from some intense shooter games to
                            role-playing. I usually play GTA V Role Play and
                            Valorant & I also play new games that come out from
                            time to time. I am a content creator for Velocity
                            Gaming "VLT". I have been streaming on YouTube for
                            the last 6yrs. I used to work at Accenture as a
                            senior analyst. Now I am a full-time streamer & in
                            all these years, one thing I understood about life
                            is{' '}
                            <span className="bold">
                    ...
                    <div className={css.support_channel_grid}>
                        <div className={css.subscribe_to_my_channel}>
                            <Image
                                ...
                                alt="youtube logo"
                            />
                            <h2 className={css.subscribetext}>
                                {' '}
                                Subscribe for amazing content, every day
                            </h2>
                            <p className={css.subscribetext_sub}>
                                Live stream every day at 9:30pm. I play GTA V
                                RolePlay, Valorant, Counter Strike and many
                                other fun games.
                            </p>
                        ...
                        <div className={css.merch_main}>
                            <div className={css.buy_merch}>
                                <div className={css.merch_oneblock}>
                                    <Image
                                        ...
                                        height={45}
                                        alt="bag"
                                        className={css.merch_oneblock}
                                    />
                                    <h1
                                        className={`${css.merch_oneblock} pd-left`}
                                    >
                                        Store
                                    </h1>
                                </div>
                                <h2 className={css.merch_title}>
                                    Support my content by purchasing my merch.
                                </h2>
                                <p className={css.merch_sub_title}>
                                    Live stream every day at 9:30pm. I play GTA
                                    V RolePlay, Valorant, Counter Strike and
                            ...
                            <div className={css.merch_gallery}>
                                <div
                                    className={`${css.merch_gallery_top_grid} iso-layout-grid`}
                                >
                                    <Image
                                        src={merch1}
                                        width={300}
                                        height={300}
                                        alt="merch1"
                                        className={css.merch_gallery_item}
                                    />
                                    <Image
                                        src={merch2}
                                        width={300}
                                ...
                                <div
                                    className={`${css.merch_gallery_bottom_grid} iso-layout-grid`}
                                >
                                    <Image
                                        src={merch3}
                                        width={300}
                            ...
                            <div className={css.buy_merch_notice}>
                                All these products are just for demonstration
                                and does not represent an actual product as of
                                now.
                            </div>
                        </div>
                    </div>
