    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="keywords"
                    content="merchandise, merch, raka, rakazone, rakazonegaming, cool, rakazone cool"
                />
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <div className={css.shop_main}>
                        ...
                        <div className={css.shop_subtitle}>
                            ...
                            elit sit enim sed non nisi ut ultrices molestie
                            null.
                        </div>
                    </div>
                </div>
                            ...
                            >
                                <div>
                                    <div className={css.shop_item}>
                                        ...
                                        <div
                                            className={
                                                css.shop_item_product_content
                                            }
                                        >
                                            <div
                                                className={
                                                    css.shop_item_details
                                                }
                                            >
                                                <div
                                                    className={
                                                        css.shop_item_product_title
                                                    }
                                                >
                                                    {product.name}
                                                </div>
                                            ...
                                            <div
                                                className={
                                                    css.shop_item_product_description
                                                }
                                            >
